...
Automatically switches between modes based on hand movement.
"""
...
from config import MODEL_PATH, LABELS_PATH, SIGN_CLASSES, DATA_DIR
...
class GesturePredictor:
    ...
    Auto-switches between static/dynamic based on hand movement.
    """
    ...
    def predict(self, landmarks):
        """
        Predict gesture using hybrid approach.
